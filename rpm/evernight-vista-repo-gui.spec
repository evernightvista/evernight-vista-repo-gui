...
Requires:       polkit
Requires:       evernight-vista-repos >= 45-1
...
%changelog
* Sun Aug 16 2026 KairikiFedora <13278297951@sina.cn> - 1.0.2-1
- Adapt to dnf5 repo directory move from /etc/yum.repos.d to /usr/share/dnf5/repos.d
